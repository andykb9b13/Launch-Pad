  ...
  return (
    <div className='max-w-[1200px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
      <div className='mx-auto p-4 flex flex-col justify-center'>
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4 bg-[var(--lime)] my-4 p-2 rounded-lg'>
      {products &&
        products.map((product, i) => (
          <div key={i} className="flex flex-col justify-center p-4 bg-[var(--white)] shadow-md shadow-[var(--green)] group container rounded-lg">
            <div className='flex flex-col justify-center p-6'>
              ...
              <a className='py-2' href={product.externalLink} target='_blank'>More Info For This Item</a>
                <div className="tracking-widest my-4 mx-auto border-2 border-[var(--lime)] rounded-lg p-4">
                  <Link to={`/product/${product._id}`} product={product} className='text-[var(--)]'>
                    Fund This Product!
                  </Link>
                </div>
            </div>
